...
def parse_tool_calls(text: str, supported_functions: dict[str, FunctionDefinition] | None = None) -> List[ToolCall]:
    ...
    for param_name, param_value in parameters:
        ...
        if expected_type == 'array' or expected_type == 'object':
            try:
                ...
                log.debug(f"function parameter parsing error, parameter '{param_name}', value '{param_value_norm}', "
